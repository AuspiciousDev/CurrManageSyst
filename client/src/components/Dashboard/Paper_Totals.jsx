...
const Paper_Totals = (props) => {
  ...
  const StyledPaper = styled(Paper)(({ theme }) => ({
    "&.MuiPaper-root ": {
      ...
      borderRadius: 5,
      padding: "10px",
      borderBottom: `solid 1px ${colors.defaultColor[500] + 50}`,
      borderRight: `solid 1px ${colors.defaultColor[500] + 50}`,
      boxShadow: `${colors.defaultColor[500] + 40} 1.95px 1.95px 2.6px;`,
    },
