      ...
      renderCell: (params) => {
        return (
          <Box display="flex" gap={2}>
            <Link
              to={`/chair/curriculums/${currYear}/${courseYear}/${params?.value}`}
              style={{
                alignItems: "center",
                textDecoration: "none",
              }}
        ...
        return (
          <Box sx={{ display: "flex", gap: 2 }}>
            <ButtonBase
              onClick={() => {
                navigate(
                  `/chair/feedbacks/${currYear}/${courseYear}/${params?.row?.currVer}/${params?.row?.currVerID}/create`
                );
              }}
            >
            ...
            <ButtonBase
              onClick={() => {
                navigate(
                  `/chair/feedbacks/${currYear}/${courseYear}/${params?.row?.currVer}/${params?.row?.currVerID}`
                );
              }}
            >
...

    {
      ...
      renderCell: (params) => {
        return (
          <>
            <ButtonBase
              disabled={params.value !== "chairReview"}
              onClick={() => {
                setValidateDialog({
                  isOpen: true,
                  onConfirm: () => {
          ...
          <>
            <Box sx={{ display: "flex", gap: 2 }}>
              <ButtonBase
                ...
                onClick={(event) => {
                  navigate(`/chair/generate/${params?.row.currVerID}`);
                }}
              >
                <Paper_Icon
...
export default ChairCurriculum;
