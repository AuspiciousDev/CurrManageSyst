    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setSuccessDialog({
          ...
          message: `Account for ${
            gender === "male" ? "Mr. " : "Ms. "
          } ${lastName} ${doc.email} has been created!`,
        });
        clearFields();
      }
            ...
            <Box>
              ...
              >
                <FormControl required fullWidth>
                  ...
                  >
                    {/* <MenuItem value={"admin"}>Dean</MenuItem> */}
                    <MenuItem value={"comChair"}>Committee Chair</MenuItem>
                    <MenuItem value={"comMem"}>Committee Members</MenuItem>
