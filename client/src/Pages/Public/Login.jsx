      ...
      try {
        ...
        if (apiLogin.status === 200) {
          ...
          from === "/" && userType === "admin"
            ...
            : from === "/" && userType === "comChair"
            ? navigate("/chair", { replace: true })
            : from === "/" && userType === "comMem"
            ? navigate("/member", { replace: true })
            : from === "/" && userType === "stakeholder"
            ...
            <Box className="container-column" sx={{ gap: 2.5, mt: 5 }}>
              ...
              <Button
                ...
                sx={{
                  borderRadius: 4,
                  height: 45,
                  backgroundColor: colors.defaultColor[500],
                }}
              >
              ...
              {/* <Typography textAlign="center">
                ©AuspiciousDev on Curriculum Management System. All right
                reserved. Removed on Full payment
              </Typography> */}
            </Box>
          </form>
        </Paper>
